...
def test_add_zero_complication_minimal_complexity():
    ...
    # Should be 2 * expr.complexity() + 1.0 for additional node
    expected = 2 * expr.complexity() + 1.0
...
def test_add_zero_complication_apply_invalid_index():
    """Test applying AddZeroComplication with invalid index raises error."""
    expr = Integer(5)
